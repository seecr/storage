...
class StorageTest(TestCase):
    ...
    def testGetData(self):
        ...
        stream = s.get('mydata')
        self.assertEqual('some data of mine', ''.join(stream))
    ...
    def testPutStorage(self):
        ...
        self.assertEqual('data', ''.join(s2.get('s1').get('mydata')))
        self.assertEqual('data', ''.join(s1.get('mydata')))
        self.assertEqual('data', ''.join(newStorage.get('mydata')))
    ...
    def testCreateTempStorage(self):
        ...
        sink.close()
        s.put('mystore', stemp)
        self.assertEqual('data', ''.join(s.get('mystore').get('mydata')))
    ...
    def assertName(self, name):
        ...
        sink.send('data')
        sink.close()
        self.assertEqual('data', ''.join(s.get(name)))
